...
export default class Anuncios extends Component {
    ...
    render() {
        let { anuncio } = this.props
        let {cargadoS,searchAnuncios} = this.props

        console.log(searchAnuncios);
        console.log(cargadoS);
        

        if(!cargadoS){
            console.log("holy no hay searchAnuncios");
            return (
            ...
            console.log("holy si hay searchAnuncios");
            return (
                ...
                <React.Fragment>
                    ...
                    <div className="row">
                        ...
                        <div className="wrapper  col-lg-3 ">
                            {/* <ImageA src={this.src}/>  */}
                            {/* <img class="img-responsive" src={'http://localhost:3700/api/getImagesByName/' + anuncio.t_fotos[0].fot_img} alt="" /> */}
                            <img class="img-responsive" src={searchAnuncios.t_fotos[0].fot_img} alt="" />
                            {/* <img style="height: 200px; width: 100%; display: block;" src="" alt="Card image"> */}
                        ...
                        <div className="col-lg-9">
                            <a href="#" className="list-group-item list-group-item-action flex-column align-items-start active">
                                <div className="d-flex w-100 justify-content-between">
                                    <h5 className="mb-1">Descripcion</h5>
                                    <small>{this.publicationTime(searchAnuncios.publi_fecha)}</small>
                                </div>
                                <p className="mb-1">{searchAnuncios.publi_descripcion}</p>
                                {/* Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit. */}
                                <small>{searchAnuncios.publi_titu}</small>
                                {/* Donec id elit non mi porta. */}
                            </a>
                            {/* style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);" */}
                            <div className="btn-group" role="group" aria-label="Button group with nested dropdown">
